...
return [
    ...
    'phone'                => 'Значение поля :attribute содержит неверное значение.',
    ...
    'attributes'           => [
        ...
        'data.ogrn'                => 'ОГРН',
        'data.ogrnip'              => 'ОГРНИП',
        'data.passport'            => 'паспорт',
        'data.passport_issue'      => 'кем выдан паспорт',
        'data.passport_issue_at'   => 'когда выдан паспорт',
